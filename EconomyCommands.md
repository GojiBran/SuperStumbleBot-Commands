...
| `.adventure`          | Engage in a high-risk, high-reward scenario (5-minute cooldown).            |
| `.snarfbux`           | Lose a random amount of GojiBux (5-250 GBX) with a 1-minute cooldown.       |
| `.give bux`            | Give GojiBux to another user or a random user.                              |
| `.donate bank`         | Donate GojiBux to the LGH Bank.                                             |
| `.stash gbx`              | Stash GojiBux into an offshore account with a 10-second cooldown.           |
| `.withdraw gbx`            | Withdraw GojiBux from the offshore stash.                                   |
| `.my stash`            | Check the amount of GojiBux stashed offshore.                               |
| `.lgh`                | Displays the total GojiBux stored in the LGH Bank.                          |
| `.economy`            | Shows total economy stats, including circulation and weed prices.           |
| `.gamble` / `.bet`    | Gamble GojiBux for a chance to win or lose.                                 |
| `.rob bank`            | Attempt to rob the LGH Bank (2-minute cooldown).                            |
| `.steal`              | Attempt to steal GojiBux from another user.                                 |
| `.send gbx`            | Send GojiBux to another user.                                               |
| `.gojicoin`           | Buy a GojiCoin for 1 Billion GBX.                                           |
| `.gojicoin balance`   | Check total GojiCoins owned.                                                |
| `.treat`              | Donate GojiBux and weed to Goji.                                            |
| `.give pot`            | Contribute to the GojiBux Pot.                                              |
| `.get pot`             | Claim the GojiBux Pot (20-minute cooldown).                                 |
| `.pot`                | Display the current GojiBux Pot balance.                                    |
| `.top` / `.leaderboard`| Displays the top players in various categories.                            |
| `.top coin`            | Displays the top GojiCoin holders.                                          |
| `.top gbx`             | Shows the top 10 richest users in GojiBux.                                  |
| `.top stash`           | Shows the top 10 users with the largest offshore stash.                     |
| `.top weed`            | Shows the top 10 users with the most weed stash.                            |
| `.top joint`          | Displays the top users with the most joints.                                |
| `.top spaget`          | Shows the top 10 users with the most spaghetti.                             |
| `.top pizza`           | Shows the top 10 users with the most pizza.                                 |
| `.least gbx`           | Shows the bottom 10 poorest users in GojiBux.                               |
| `.least weed`          | Shows the bottom 10 users with the smallest weed stash.                     |
| `.balance` / `.wallet`| Shows full economy details for the user.                                    |
| `.price weed`          | Shows current dynamic weed prices and economy stats.                        |
| `.stats`              | Displays bot stats, including user counts for various items.                |
...
| Command               | Description                                                                 |
|-----------------------|-----------------------------------------------------------------------------|
| `.buy weed`            | Buy weed from the market.                                                   |
| `.sell weed`           | Sell weed to the market.                                                    |
| `.donate weed`         | Donate weed to the WGH stash.                                               |
| `.grow`               | Grow a random amount of weed (30-second cooldown).                          |
| `.harvest`            | Harvest weed from Goji’s Garden (30-second cooldown).                       |
| `.rob weed`            | Attempt to rob the WGH stash (2-minute cooldown).                           |
| `.heist weed`          | Attempt a massive weed heist (10-minute cooldown).                          |
| `.joint roll`          | Roll joints using weed.                                                     |
| `.my joints`           | Check the number of joints you have.                                        |
| `.joint smoke`         | Smoke joints.                                                               |
| `.sesh`               | Group session to smoke weed with other users.                               |
| `.send weed`           | Send weed to another user.                                                  |
| `.steal weed`          | Attempt to steal weed from another user.                                    |
| `.stash weed`           | Hide weed from police busts (60-second cooldown).                           |
| `.withdraw weed`         | Retrieve hidden weed (60-second cooldown).                                  |
| `.my stash weed`        | Check how much weed is hidden.                                              |
| `.sell joint`         | Sell joints to an offshore buyer.                                           |
...
|-----------------------|-----------------------------------------------------------------------------|
| `.spaget`             | Earn spaghetti (30-minute cooldown).                                        |
| `.my spaget`           | Check your spaghetti stash.                                                 |
| `.send spaget`         | Send spaghetti to another user.                                             |
| `.steal spaget`        | Attempt to steal spaghetti from another user.                               |
| `.eat spaget`          | Eat spaghetti.                                                              |
| `.pizza` / `.pixxa`   | Earn pizza (10-second cooldown).                                            |
| `.my pizza`            | Check your pizza stash.                                                     |
| `.send pizza`          | Send pizza to another user.                                                 |
| `.eat pizza`           | Eat pizza.                                                                  |
| `.cook`               | Cook spaghetti and pizza (30-minute cooldown).                              |
...
| Command               | Description                                                                 |
|-----------------------|-----------------------------------------------------------------------------|
| `.dump all`            | Dump all GojiBux, weed, and spaghetti.                                      |
| `.dump bux`            | Dump all GojiBux.                                                           |
| `.dump weed`           | Dump all weed.                                                              |
| `.dump spaget`         | Dump all spaghetti.                                                         |